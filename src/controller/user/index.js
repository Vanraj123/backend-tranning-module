const createSuccessResponse = require('eva-utilities').utilities.createSuccessResponse;
const createErrorResponse = require('eva-utilities').utilities.createErrorResponse;
...
const { getUserById , registerUser, loginUser, updatePassword, updateProfile, softdeleteUser, harddeleteUser} = require('../../usecase/user');
